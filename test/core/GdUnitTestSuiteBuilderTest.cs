...
namespace GdUnit3.Core.Tests
{
    ...
    public class GdUnitTestSuiteBuilderTest
    {
        ...
        {
            var classPath = Godot.ProjectSettings.GlobalizePath("res://test/core/resources/sources/TestPerson.cs");
        ...
        public void CreateTestSuite()
        {
            ...
            File.Copy(Path.GetFullPath(Godot.ProjectSettings.GlobalizePath("res://test/core/resources/sources/TestPerson.cs")), sourceClass);
        ...
        public void CreateTestSuite_NoNamespace()
        {
            ...
            File.Copy(Path.GetFullPath(Godot.ProjectSettings.GlobalizePath("res://test/core/resources/sources/TestPerson2.cs")), sourceClass);
